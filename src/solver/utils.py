...
def read_solution_folder(path=Path("/Users/imandisaiganesh/Documents/VSCode/IIITHIntern/llm-puzzle-solver/data/dataset")):
...
def write_problem_folder(problems, path=Path("../../data/puzzles")):
...
def write_solution_folder(solutions, path=Path("../../data/solutions")):
    path.mkdir(exist_ok=True)
